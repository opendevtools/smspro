...
const smsProUtil = require('../smsPro')

beforeEach(() => {
  MockDate.set('2018-03-16T15:58:19.000Z')
})

describe('#mtSms', () => {
  it('returns a correctly formatted xml', () => {
    ...
    expect(dedent(response)).toEqual(
      dedent(`
        <?xml version='1.0'?>
        <mobilectrl_sms>
        <header>
            ...
            <valid_until>201803161708</valid_until>
...
describe('#parseIncoming', () => {
  it('returns correctly formated JSON', () => {
    const xmlForIncoming =
      '<?xml version="1.0" encoding="ISO-8859-1"?> <mobilectrl_received_sms><header><customer_id>CUSTOMER</customer_id> <mobilectrl_id>5aa434:eac0a56a0b:-845c</mobilectrl_id> <datetime>2014-10-25T13:43:19.000Z</datetime></header> <payload><sms account="71700" premiumrate="0"><message>Text message from mobile</message><from_msisdn operator="operator">+46708651052</from_msisdn></sms> </payload></mobilectrl_received_sms>'
    ...
    expect(data).toEqual({
      ...
      datetime: '2014-10-25T13:43:19.000Z',
      operator: 'operator',
      customerId: 'CUSTOMER',
    })
  })
