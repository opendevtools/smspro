...
describe('index', () => {
  ...
  beforeEach(() => {
    ...
    response = {
      text: stub().returns('<?xml version="1.0" encoding="ISO-8859-1"?><mobilectrl_response><customer_id>kdot</customer_id><mobilectrl_id>9123812831238</mobilectrl_id><status>0</status><code>0</code><errorcode>0</errorcode><message><![CDATA[The MT SMS request is being processed.]]></message><datetime>2018-03-16 15:58:19</datetime></mobilectrl_response>')
    }
  ...
  describe('#sendMtSms', async () => {
    ...
    it('calls send', async () => {
      smsPro = new SmsPro(config)
      smsPro.send = spy()
      await smsPro.sendMtSms({ to: ['073013371337'], from: '1337', message: 'who doesnt love k-dot though?'})
